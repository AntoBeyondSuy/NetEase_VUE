...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      changeBackground(clickIndex) {
        this.imgs.push(this.imgs2[clickIndex]);
      },
...
<style lang="stylus" scoped>
  /*imgs2: ['../../assets/music_1.jpg', '../../assets/music_2.jpg', '../../assets/music_3.jpg', '../../assets/music_4.jpg', '../../assets/music_5.jpg'],
imgs: this.imgs2[0]*/
  /*return {
items: []
}*/
  /*this.imgs.push(this.imgs2[1]);
this.imgs2.push(this.imgs[0]);
this.imgs = this.imgs.slice(1);
this.imgs2 = this.imgs2.slice(1);
        ;
        */
  *
